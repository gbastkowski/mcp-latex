...
argument-hint: [project-path-or-scope] [optional preset]
---
...
1. **Ask about the audience before reading anything**, in one `AskUserQuestion`
   round: who reads it (API consumer / maintainer / operator / mixed), what is
